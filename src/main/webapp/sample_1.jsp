			...
			success : function(rsJson) {
				if (rsJson && rsJson.status == "ok") {
					...
					for(var i=0; i<rsAr.length; i++){
						...
						listHtml += '<td class="nr3">'+rsAr[i].descstring+'</td>';
						listHtml += '<td class="nr4">'+rsAr[i].cnt+'</td>';
						listHtml += "</tr>";						
					}
...
/*이벤트*/	
	...
	$("#m_excelBtn").on("click",function(){
		...
		form.action = "m00/s02/select_m00s02_excel.jsp";
