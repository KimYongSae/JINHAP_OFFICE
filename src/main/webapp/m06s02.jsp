...
//				console.log(rsAr[0].filename);
				...
				//var file = "D:/file/m06s02/"+(decodeURIComponent(rsAr[0].filename));
				//var file = "/JINHAP_OFFICE/file/m06s02/"+(decodeURIComponent(rsAr[0].filename));
...
confirmDialog = $("#confirm-form").dialog({
	...
	buttons:{
		"삭 제":function(){
			$.post("m06/s02/delete_m06s02.jsp",{
				"cnt":fileDel_cnt
			},250);
