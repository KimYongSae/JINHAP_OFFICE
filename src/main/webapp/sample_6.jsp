               ...
               <table id="monitoring_list" cellspacing="0" class="table table-bordered table-hover table-responsive scrolltbody">
					<thead>
						...
						<tr>
							...
							style="background-color:#24FCFF; width: 170px; height: 40px; 
							font-size: 20pt; font-weight:700; font-family: headline;">
								구 분
							</th>
							
							<th colspan="5" class="text-center cell" 
							style="background-color:#24FCFF;  height: 35px; 
							font-size: 20pt; font-weight:700; font-family: headline;">
								퀜칭로
							</th>
							...
							<th rowspan="2" class="text-center cell" 
							style="background-color:#24FCFF; width: 130px; height: 60px; 
							font-size: 20pt; font-weight:700; font-family: headline;">
								중간<br />세정기
							</th>
							<th rowspan="2" class="text-center cell" 
						...
						<tr>
							...
							style="background-color:#24FCFF; width: 130px; height: 35px; 
							font-size: 20pt; font-weight:700; font-family: headline;">
								#1
							</th>
							<th class="text-center cell" 
...
function init(){
	...
	setInterval(getMonitoringList, 1000);
		...
		$.ajax({
			...
			success : function(rsJson) {
				if (rsJson && rsJson.status == "ok") {
					...
					$("#h1_sp_q1_spec").text(rsAr.q1_sp);
					$("#h1_sp_q2_spec").text(rsAr.q2_sp);
					$("#h1_sp_q3_spec").text(rsAr.q3_sp);
					$("#h1_sp_q4_spec").text(rsAr.q4_sp);
					$("#h1_sp_q5_spec").text(rsAr.q5_sp);
					$("#h1_sp_t1_spec").text(rsAr.t1_sp);
					$("#h1_sp_t2_spec").text(rsAr.t2_sp);
					$("#h1_sp_t3_spec").text(rsAr.t3_sp);
					$("#h1_sp_t4_spec").text(rsAr.t4_sp);
					$("#h1_sp_mw").text(rsAr.a_sp); // 중간세정기
					$("#h1_sp_oil").text(rsAr.oil_sp);	// 유조
					$("#h1_sp_cp").text(rsAr.cp_sp.toFixed(3)); // cp
		...
		$.ajax({
			...
			success : function(rsJson) {
				if (rsJson && rsJson.status == "ok") {
					...
					$("#h2_sp_q1_spec").text(rsAr.q1_sp);
					$("#h2_sp_q2_spec").text(rsAr.q2_sp);
					$("#h2_sp_q3_spec").text(rsAr.q3_sp);
					$("#h2_sp_q4_spec").text(rsAr.q4_sp);
					$("#h2_sp_q5_spec").text(rsAr.q5_sp);
					$("#h2_sp_t1_spec").text(rsAr.t1_sp);
					$("#h2_sp_t2_spec").text(rsAr.t2_sp);
					$("#h2_sp_t3_spec").text(rsAr.t3_sp);
					$("#h2_sp_t4_spec").text(rsAr.t4_sp);
					$("#h2_sp_mw").text(rsAr.a_sp); // 중간세정기
					$("#h2_sp_oil").text(rsAr.oil_sp);	// 유조
					$("#h2_sp_cp").text(rsAr.cp_sp.toFixed(3)); // cp
		...
		$.ajax({
			...
			success : function(rsJson) {
				if (rsJson && rsJson.status == "ok") {
					...
					$("#h4_sp_q1_spec").text(rsAr.q1_sp);
					$("#h4_sp_q2_spec").text(rsAr.q2_sp);
					$("#h4_sp_q3_spec").text(rsAr.q3_sp);
					$("#h4_sp_q4_spec").text(rsAr.q4_sp);
					$("#h4_sp_q5_spec").text(rsAr.q5_sp);
					$("#h4_sp_t1_spec").text(rsAr.t1_sp);
					$("#h4_sp_t2_spec").text(rsAr.t2_sp);
					$("#h4_sp_t3_spec").text(rsAr.t3_sp);
					$("#h4_sp_t4_spec").text(rsAr.t4_sp);
					$("#h4_sp_mw").text(rsAr.a_sp); // 중간세정기
					$("#h4_sp_oil").text(rsAr.oil_sp);	// 유조
					$("#h4_sp_cp").text(rsAr.cp_sp.toFixed(3)); // cp
		...
		$.ajax({
			...
			success : function(rsJson) {
				if (rsJson && rsJson.status == "ok") {
					...
					$("#h5_sp_q1_spec").text(rsAr.q1_sp);
					$("#h5_sp_q2_spec").text(rsAr.q2_sp);
					$("#h5_sp_q3_spec").text(rsAr.q3_sp);
					$("#h5_sp_q4_spec").text(rsAr.q4_sp);
					$("#h5_sp_q5_spec").text(rsAr.q5_sp);
					$("#h5_sp_t1_spec").text(rsAr.t1_sp);
					$("#h5_sp_t2_spec").text(rsAr.t2_sp);
					$("#h5_sp_t3_spec").text(rsAr.t3_sp);
					$("#h5_sp_t4_spec").text(rsAr.t4_sp);
					$("#h5_sp_mw").text(rsAr.a_sp); // 중간세정기
					$("#h5_sp_oil").text(rsAr.oil_sp);	// 유조
					$("#h5_sp_cp").text(rsAr.cp_sp.toFixed(3)); // cp
		...
		$.ajax({
			...
			success : function(rsJson) {
				if (rsJson && rsJson.status == "ok") {
					...
					$("#h6_sp_q1_spec").text(rsAr.q1_sp);
					$("#h6_sp_q2_spec").text(rsAr.q2_sp);
					$("#h6_sp_q3_spec").text(rsAr.q3_sp);
					$("#h6_sp_q4_spec").text(rsAr.q4_sp);
					$("#h6_sp_q5_spec").text(rsAr.q5_sp);
					$("#h6_sp_t1_spec").text(rsAr.t1_sp);
					$("#h6_sp_t2_spec").text(rsAr.t2_sp);
					$("#h6_sp_t3_spec").text(rsAr.t3_sp);
					$("#h6_sp_t4_spec").text(rsAr.t4_sp);
					$("#h6_sp_mw").text(rsAr.a_sp); // 중간세정기
					$("#h6_sp_oil").text(rsAr.oil_sp);	// 유조
					$("#h6_sp_cp").text(rsAr.cp_sp.toFixed(3)); // cp
