...
<%
	    ...
	    String sql = " INSERT INTO tb_spare (seolbi, component_name, usage_location, specifications, manufacturer, replacement_frequency, purchase_cycle, current_stock, safety_stock, shortage_stock, unit, storage_location, rack_number, purchase_request, remarks) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
