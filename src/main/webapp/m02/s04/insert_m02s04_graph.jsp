...
try{
	...
	String year = multiRequest.getParameter("graph_year");
	String hogi = multiRequest.getParameter("graph_hogi");
	String bungi = multiRequest.getParameter("graph_bungi");
	...
	u_sql.append("UPDATE tb_heatoil_file SET file_graph"+hogi+" = '"+filename+"', file_graph_yn"+hogi+"='Y' ");
