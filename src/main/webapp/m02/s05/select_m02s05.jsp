...
<%
	...
	sql.append("SELECT hogi, IFNULL(change_bdate,'') AS change_bdate, ");
	sql.append("change_ndate, change_date, bigo1, ");
	sql.append("filename, file_yn, ");
	sql.append("year1, cnt ");
	sql.append("FROM tb_o2sensor ");
	sql.append("WHERE 1=1 ");
	sql.append(whereSql.toString());
	sql.append("ORDER BY year1, hogi ");
	Statement stmt = null;
	ResultSet rs = null;
		     try {
...
//		    		 rowObj.put("hogi",rs.getString("hogi"));					//호기 
					...
					rowObj.put("bigo1",rs.getString("bigo1"));			//파일명
