					...
					<thead>
						...
						<tr>
							<th class="text-center cell" 
								style="background-color:#36FFFF; width: 100px; height: 70px; 
								font-size: 16pt; font-family:headline; font-weight:700;
								">
								LOT No.
							</th>
							<th class="text-center cell" 
								style="background-color:#36FFFF; width: 400px; height: 70px; 
								font-size: 16pt; font-family:headline; font-weight:700;">
								품번
							</th>							
							<th class="text-center cell" 
							...
							<th class="text-center cell" 
								style="background-color:#36FFFF; width: 180px; height: 70px; 
								font-size: 16pt; font-family:headline; font-weight:700;">
								열처리<br>투입시간
							</th>							
							<th class="text-center cell" 
