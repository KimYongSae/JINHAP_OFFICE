            ...
            <div id="collapse4" class="body">
               ...
               <table id="malarm_list" cellspacing="0" class="table table-bordered table-hover table-responsive scrolltbody">
					<thead>
						...
						<tr>
							<th class="text-center cell" 
								style="background-color:#36FFFF; width: 650px; height: 40px; 
					...
					<tbody id="malarm_contents">
						<tr>
							...
							height: 40px; width: 650px; word-break:break-all; font-size:16pt; 
							font-weight: 600; font-family:headline;">경보내용</td>
						</tr>
						<tr>
							<td style="text-align: center; vertical-align: middle; padding: 1px; 
							height: 40px; width: 650px; word-break:break-all; font-size:16pt; 
               ...
               <table id="malarm_list" cellspacing="0" class="table table-bordered table-hover table-responsive scrolltbody">
					...
					<tbody id="malarm_contents">
						...
						<tr>
							<td style="background-color:red;text-align: center; vertical-align: middle; padding: 1px; 
							height: 40px; width: 650px; word-break:break-all; font-size:16pt; 
							font-weight: 600; font-family:headline;">경보내용</td>
						</tr>
						<tr>
