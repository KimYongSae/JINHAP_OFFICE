  ...
  <div style="width: 100%; " class="col-lg-12">
        <div class="box">
            <header>
                ...
                <h5 style="font-family: headline; font-size:14pt;">생산관리 - LOT 보고서</h5>
            </header>
            	...
            	<div class="container">
	            	<div class="row">
            			<div class="col-xs-5">
			            	...
			            	<div class="row">
			            		<div id="donutChart" class="col-xs-4"></div>
			            		<div id="pieChart" class="col-xs-4"></div>
			            		<div id="radarChart" class="col-xs-4"></div>
			            	</div>
			            </div>
            			<div class="col-xs-7">
							<table class="table table-bordered table-hover table-responsive scrolltbody">
								<thead>
									<tr>
										<th class="text-center cell" 
											style="background-color:#36FFFF; width: 1000px; height: 70px; 
...
<!--END TEXT INPUT FIELD-->
	...
	var chart4 = bb.generate({
	  data: {
	    ...
	    type: "donut", // for ESM specify as: gauge()
	    onclick: function(d, i) {
		console.log("onclick", d, i);
	   },
	    onover: function(d, i) {
