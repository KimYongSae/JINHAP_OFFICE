...
<body onload="init();" data-offset="60" data-target=".navbar" style="background-color:white">
            ...
            <div class="row">
             	...
             	margin-top:10px; margin-bottom:2px;">3호기 이전 작업</h4>
...
function getAllListBefore(){
	$.ajax({
		type : "POST",
		url : "m01/s05/select_m01s05_ht3_monitor_before.jsp",
		cache : false,
		dataType : "json",
		data : {'time':new Date().getTime(),
				"tdate":$("#tdate").val()},
...
function getAllListAfter(){
	$.ajax({
		type : "POST",
		url : "m01/s05/select_m01s05_ht3_monitor_after.jsp",
		cache : false,
		dataType : "json",
		data : {'time':new Date().getTime(),
				"tdate":$("#tdate").val()},
