...
//String sdate = request.getParameter("sdate");
	...
	String delayEdate = sdate + " 20:00:00";
	...
	try{
		 ...
		 sql.append("        AND STR_TO_DATE(datetiem1, '%Y%m%d%H%i%s') BETWEEN '" + sdate + " 07:00:00' AND '" + sdate + " 21:00:00' ");
		 sql.append("        ORDER BY hogi ");
		 sql.append("    ) AS main ");
		 sql.append(") AS sub ");
		 sql.append("WHERE STR_TO_DATE(IFNULL(sub.first_datetiem1_in_group, '1970-01-01 00:00:00'), '%Y-%m-%d %H:%i:%s') BETWEEN '" + sdate + " 08:00:00' AND '" + sdate + " 20:00:00'  ");
