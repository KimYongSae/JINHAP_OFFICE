...
<%
	...
	lotSql.append("pre, oil, post, cp, q_inv, t_inv, model, spec, (speed*0.1) AS speed, ");
	...
	lotSql.append("process_code AS heatno, TIMESTAMPDIFF(MINUTE, work_start, input_end) AS duration ");
