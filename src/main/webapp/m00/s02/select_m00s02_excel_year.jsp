...
<%
	...
	int hogi = Integer.parseInt(request.getParameter("y_hogi"));
	String ydate = request.getParameter("y_date");

	SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMddHHmmss");
	Date now = new Date();
	

	String sFileName = "알람목록_" +ydate+"_"+sdf.format(now)+".xlsx";
	...
	{	
		...
		whereSql.append(" AND year1 = '"+ydate+"' ");
		
		s_sql.append("SELECT AreaMask, descString,  ");
		s_sql.append("year1, cnt ");
		s_sql.append("FROM v_ae_rank_y ");
		...
		objCell.setCellValue("발생년도"); objCell.setCellStyle(styleHd);		

		objCell = objRow.createCell((short)1);
		objCell.setCellValue(ydate+"년"); objCell.setCellStyle(styleHd);			
