...
<%
	...
	String sFileName = sdate + "~" + edate + "_알람목록_" +sdf.format(now)+".xlsx";
	...
	{	
		...
		objCell.setCellValue("기간"); objCell.setCellStyle(styleHd);		

		objCell = objRow.createCell((short)1);
		objCell.setCellValue(sdate + "~" + edate); objCell.setCellStyle(styleHd);			
