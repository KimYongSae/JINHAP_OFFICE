...
try{
	...
	int import_cnt = Integer.parseInt(multiRequest.getParameter("import_cnt_bungi"));
	int gb = Integer.parseInt(multiRequest.getParameter("import_gb_bungi"));
	...
	switch(gb){
		case 1: 
			u_sql.append("UPDATE tb_sat_file_bungi SET filename_"+gb+" = '"+filename+"', file_yn_"+gb+"='Y' ");
