<%@page import="org.apache.poi.ss.formula.Formula"%>
<%@page import="org.apache.poi.ss.usermodel.FormulaEvaluator"%>
<%@page import="net.sf.jasperreports.functions.standard.MathFunctions"%>
<%@page import="org.json.simple.JSONArray"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%!
	public class Ppk_Calc{
	/*
...
//				System.out.println("[j"+(j+1)+"]"+Double.parseDouble(stevArray.get(j).toString()));
			...
			//5. 4.에서 구한값의 *1/2 (제곱근)
			double powSqrt = Math.sqrt(powAverage);
			...
			if((100 - blankCnt) == 0 || textCnt > 0 || error >0){
				...
				result = String.format("%.4f",powSqrt);	
			}
