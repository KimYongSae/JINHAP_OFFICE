			...
			<div class="row">
              <table id="temp"
               ...
               style= "font-size: 30px; width: 1400px; margin: auto; height: 750px;">
						...
						<tr>
							<th rowspan = "2" style="background-color: white;width:450px; color:black">6호기(시간당 1000kg)<br/> 설비효율</th>
...
//				timer = setTimeout(function(){ o.run(); }, o.pollInterval);
	...
	function getDayData(){
		$.ajax({
			url:"m01/s02/select_m01s02_ht6_monitor_day.jsp",
			type:"post",
			dataType:"json",
			data:{},
	...
	function getNightData(){
		$.ajax({
			url:"m01/s02/select_m01s02_ht6_monitor_night.jsp",
			type:"post",
			dataType:"json",
			data:{},
			success:function(result){
	...
	function getTotalData(){
		$.ajax({
			url:"m01/s02/select_m01s02_ht6_monitor_total.jsp",
			type:"post",
			dataType:"json",
			data:{},
			success:function(result){
	...
	function getPnameData(){
		$.ajax({
			url:"m01/s02/select_m01s02_ht6_monitor_lot.jsp",
			type:"post",
			dataType:"json",
			data:{},
			success:function(result){
